...
class AvccBox(Mp4Box):
    def __init__(self, fp, header, parent):
        ...
        try:
            ...
            if (
                self.box_info["avc_profile_indication"] == 100
                or self.box_info["avc_profile_indication"] == 110
                or self.box_info["avc_profile_indication"] == 122
                or self.box_info["avc_profile_indication"] == 144
                    ...
                    if this_descriptor_dict["specific_info_flag"]:
                        ...
                        if es_type == 5:
                            ...
                            if decoder_specific_dict["freq_id"] == 15:
                                ...
                                bits_read -= 8
                                decoder_specific_dict["freq_value"] = (
                                    four_bytes >> (32 - bits_read - field_size) & 16777215
                                )
                                # adjust to two_bytes
    ...
    def __init__(self, fp, header, parent):
        ...
        try:
            ...
            if self.box_info["default_isProtected"] == 1 and self.box_info["default_Per_Sample_IV_Size"] == 0:
                ...
                self.box_info["default_constant_IV"] = binascii.b2a_hex(
                    fp.read(self.box_info["default_constant_IV_size"])
                ).decode("utf-8")
        finally:
            fp.seek(self.start_of_box + self.size)
...
class Tx3gBox(Mp4FullBox):
    def __init__(self, fp, header, parent):
        ...
        try:
            ...
            self.box_info["background_color_rgba"] = {
                "red": read_u8(fp),
                "green": read_u8(fp),
                "blue": read_u8(fp),
                "alpha": read_u8(fp),
            ...
            read_u32(fp)
            self.box_info["default_text_box"] = {
                "top": read_i16(fp),
                "left": read_i16(fp),
                "bottom": read_i16(fp),
                "right": read_i16(fp),
