        ...
        if frame_idx in self.gaze:
            for g in self.gaze[frame_idx]:
                g.draw(
                    frame,
                    self.cam_params,
                    sub_pixel_fac=self.sub_pixel_fac,
                    clr=self.vid_pos_color,
                    radius=self.vid_pos_radius,
                    thickness=self.vid_pos_thickness,
                    draw_3d_gaze_point=self.world_pos_color is not None,
                    world_clr=self.world_pos_color,
                    world_radius=self.world_pos_radius,
